...
mov eax, 10 ;a eax le da 10
mov ebx, 5 ; a ebx le da 5
add eax, ebx ;suma ebx a eax

; Instrucción lógica (AND)
and eax, 0xF compara los bits de el valor de eax
con el de F en hexadecimal que seria tambien 15

; Instrucciones de manipulación de bits
shl eax, 1 ;duplica el valor de eax pq lo mueve un bit
